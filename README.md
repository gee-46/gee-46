...
AI & Data Science Engineering student building **end-to-end AI systems** with a focus on:

* Retrieval-Augmented Generation (RAG)
* Computer Vision applications
* Production-oriented ML pipelines

Interested in solving real-world problems through **system design, not just model training**.
...
* Designed and built a modular Retrieval-Augmented Generation pipeline
* Implemented semantic embeddings and FAISS-based retrieval
* Integrated local LLM (Ollama) with pluggable backend design
* Focus: grounding LLM responses using external knowledge
...
- 🥈 **4th Place — INNOVATEx 4.0 (International Tech Fest, Presidency University, Bangalore)**  
  *24-hour hackathon | Theme: Build with AI*
...
- 🏆 **Solution Challenge Badge — Build with AI (Hack2Skill, India)**  
  - Recognized for contributing AI-based solutions to real-world challenges  

- 🧿 **IBM Skill Badges in AI & Data Science**  

- 📈 Built and deployed **real-world ML & Computer Vision systems**  
